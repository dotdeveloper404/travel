        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <select
              ...
              v-model="h"
              class="form-control" >
                <option v-for="(item,item_index) in hotels" :key="item_index" :value="item" :selected="inArray(item,hotels)">
                {{ item }}
              </option>
              <!-- <option v-for="(item,item_index) in packages.hotels" :key="item_index" :value="item.pivot.hotel_id">
              {{ item.name }}
              </option> -->
  ...
  methods: {
    onChangeSite(e) {
      var id = e.target.value;
        console.log(id);
      if(this.package_hotel.some(x=>x===id)) this.package_hotel.pop(id);
        
        this.package_hotel.push(id);
