          ...
          <div class="panel-body"> 
           ADD NEW<i class="fa fa-plus pull-right"  @click="addRow" style="font-size:25px;color:#337ab7;cursor:pointer"></i>
            ...
            <thead class="text text-success">
                ...
                <tbody>
                   <tr v-for='(itenary, index) in itenaries' :key="itenary.day">                            
                    <td>
...
export default {
  props:['packageData','packageType','productType'],
  mounted() {
  ...
  data() {
    ...
    return {
      ...
      addedImages: [],
      savedImages: [],
      itenaries: this.packageData.itenary == null ?  this.itenaries.push({day:'',detail:''}) : JSON.parse(this.packageData.itenary)    
    };
  },
  computed: {
