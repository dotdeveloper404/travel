    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="input-group input-group-lg">
              <input
                ...
                class="form-control form-control-solid"
              />
              <img style="height: 100px" :src="tour.image_path" />
            </div>
          </div>
          ...
          <div class="form-group">
            <h5>Select Transports:  <label class="lbl_select_transports" ><input type="checkbox" true-value="1" false-value="0"  v-model="tour.is_transport_included" /> Included ? </label></h5>
            <select
               multiple
              required
              ...
              class="form-control" >
              <option
                v-for="(item,item_index) in transports" :key="item_index"  :value="item.id">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <h5>Acommodation   <label> <input type="checkbox" true-value="1" false-value="0"  v-model="tour.is_acommodation_included" /> Included?</label> </h5>

              <editor
                api-key="vr8pakupqq4xfr4f3xwlnv8dohf6u8ps301szas02f8e32ea"
                v-model="tour.acommodation"
                :init="{
                  height: 500,
                  menubar: false,
                  plugins: [
          ...
          <div class="form-group">
            <h5>Guide   <label> <input type="checkbox" true-value="1" false-value="0"  v-model="tour.is_guide_included" /> Included?</label> </h5>
          ...
          <div class="form-group">
            <h5>Additional Services   <label> <input type="checkbox" true-value="1" false-value="0"  v-model="tour.is_additional_services_included" /> Included?</label> </h5>

              <editor
                api-key="vr8pakupqq4xfr4f3xwlnv8dohf6u8ps301szas02f8e32ea"
                v-model="tour.additional_services"
                :init="{
                  height: 500,
                  menubar: false,
                  plugins: [
          ...
          <div class="form-group">
            ...
            <div class="input-group input-group-lg">
              <update-media
                ...
                :media-server="'/tour/media/' + this.tour.id"
...
export default {
  props: ["tourData", "tourType", "productType", "transports"],
  components: {  Editor },
  mounted() {
    console.log("Component mounted.");
      this.tour.transports.forEach((v,i)=>{
