              ...
              <div class="row x-gap-20 y-gap-20">
                ...
                <div class="col-md">
                  <div class="row x-gap-10 items-center">
                    <div class="col-auto">
                      <p class="text-14 lh-14 mb-5">{{ str_replace('_',' ' , strtoupper($tour->product_type)) }}</p>
                    </div>
                  </div>

                  <h3 class="text-18 lh-16 fw-500">{{ $tour->tour_name}}</h3>
                  <p class="text-14 lh-14 mt-5">{{ $tour->nights}} Nights & {{$tour->days}} Days</p>

                  <div class="text-14 lh-15 fw-500 mt-20">{{ str_replace('_',' ' , strtoupper($tour->tour_type)) }}</div>
                  <div class="text-14 text-green-2 fw-500 lh-15 mt-5">{{ $tour->seasonality}}</div>
                </div>
