                            ...
                            <div class="sidebar-checkbox">
                                ...
                                <div class="row y-gap-10 items-center justify-between">
                                    <div class="col-auto">
                                        ...
                                        <div class="d-flex items-center">
                                            <div class="form-checkbox ">
                                                <input type="checkbox" name="tour_type[]" {{ request()->get('tour_type') == $key ? 'checked' : '' }} value="{{$type}}">
                                                <div class="form-checkbox__mark">
                                                    <div class="form-checkbox__icon icon-check"></div>
                                                </div>
                                            </div>
                            ...
                            <div class="row x-gap-20 y-gap-20 p-2">
                                <div class="col-md-auto">
                                    ...
                                    <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 h-full rounded-8">
                                        <div class="cardImage__content" id="imgbx">
                                            ...
                                            <img class="rounded-8 col-12 js-lazy" src="#" data-src="{{asset('storage/uploads/tour_images/featured_image/' . $tour->featured_image)}}" alt="image">
                                ...
                                <div class="col-md">
                                    ...
                                    <p class="text-12">
                                        ...
                                        <a href="javascript:void(0);" class="text-dark-1">{{$tour->reviews != null ? $tour->reviews . ' reviews' : '' }} </a>
                                    </p>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6 col-8">
                                            <span class="text-13"> {{$tour->country}}</span>
                                        </div>
                                        <div class="col-md-6 col-4">
                                        ...
                                        <div class="col-md-6 col-8">
                                            <span class="text-13">{!! $tour->description !!}</span>
                                        </div> -->
                                        ...
                                        <div class="col-md-6 col-8">
                                            <span class="text-13">{{$tour->seasonality}}</span>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-8">
                                            <span class="text-13">{{$tour->duration}}</span>
                                        </div> -->
                                        ...
                                        <div class="col-md-6 col-8">
                                            <span class="text-13 tag_selector">{{$tour->group_type}}</span>
                                        </div>
