        ...
        <div class="row y-gap-30">
            <div class="col-lg-8">
                ...
                <div class="main-tabs">
                    <nav>
                        <div class="overview-tabs--">
                            <button class="tabs-btn text-13 uppercase  fw-700 " style="display:none;" id="tabs-hotels-btn">Hotels</button>
                            <button class="tabs-btn text-13 uppercase  active fw-700 show" id="tabs-transport-btn">Transport</button>
                        </div>
                    </nav>
                    <div class="overview-tab-content mt-15">
                        <div class="tabs-content relative overflow-hidden " id="tab-hotels-content">
                        ...
                        <div class="tabs-content relative overflow-hidden show" id="tab-transport-content">
                ...
                <p class="mt-3">Start and end in Istanbul! With the In-depth Cultural tour Turkey Classics Tour, you
                    have a 7 days
                    tour tour taking you through Istanbul, Turkey and 10 other destinations in Turkey. Turkey
            ...
            <div class="col-lg-4">
                ...
                <div class="tour-wrapper mb-3">
                    ...
                    <p class="mb-2">Start and end in <strong>{{$tour->city}}</strong></p>
                    <p class="mb-2">Seasonality <strong>{{$tour->seasonality}}</strong></p>
                ...
                <div class="d-flex justify-end js-pin-content">
                    <div class="w-390 lg:w-full d-flex flex-column items-center">
                        <div class="px-30 py-30 rounded-4 border-light bg-white shadow-4">
                            <div class="text-14 text-light-1">
                                ...
                                @endif
                                tour Price<span class="text-20 fw-500 text-dark-1 ml-5">$
...
<section>
    <div class="container">
        <div class="row y-gap-20">
            <div class="col-lg-4">
                <h2 class="text-22 fw-500">Frequently Asked Questions<br> {{ $tour->name}}</h2>
            </div>
        ...
        <div class="row justify-between items-end">
            <div class="col-auto">
                <div class="sectionTitle -md">
                    <h2 class="sectionTitle__title">Similar Tours</h2>
...
<div class="col-xl-3 col-lg-3 col-sm-6">
    ...
    <a href="{{ route('tours.show',$tour->slug) }}" class="tourCard -type-1 rounded-4 ">
        <div class="tourCard__image">

            <div class="cardImage ratio ratio-1:1">
                <div class="cardImage__content">
                    <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{ asset('storage/uploads/tour_images/featured_image/' . $tour->featured_image )  }}" alt="image">
                </div>
        ...
        <div class="tourCard__content mt-10">
            ...
            <p class="text-light-1 lh-14 text-14 mt-5">{{$tour->city}}</p>
            ...
            <div class="row justify-between items-center pt-15">
                ...
                <div class="col-auto">
                    <div class="d-flex items-center">
                        <div class="d-flex items-center x-gap-5">
                            ...
                            {!! $tour->stars == 1 ? ' <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                            {!! $tour->stars == 2 ? ' <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                            {!! $tour->stars == 3 ? ' <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                            {!! $tour->stars == 4 ? ' <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                            {!! $tour->stars == 5 ? ' <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>
                            <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                        ...
                        <div class="text-14 text-light-1 ml-10">{{$tour->reviews != null ? $tour->reviews . ' reviews' : '' }}</div>
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div class="text-14 text-light-1">
                        ...
                        @if($tour->discount > 0)
                        <p class="text-12">From <span class="line-through text-15 fw-600">${{$tour->tour_price}}
                            </span> <br>
                            <strong class="text-info-2 text-20"> ${{$tour->net_amount}}</strong>
                        </p>
                        @else
                        <p class="text-12">
                            <strong class="text-info-2 text-20"> ${{$tour->net_amount}}</strong>
