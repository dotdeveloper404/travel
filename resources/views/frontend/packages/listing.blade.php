...
@else
    @section('title')
        Affordable and best turkey Custom Tour Packages
    @endsection
@endif
...
@else
    @section('description')
        Discover Turkey's rich cultural heritage and natural beauty with our custom tour packages. Explore our diverse range
        of tour packages, covering destinations like Istanbul, Cappadocia, Ephesus, and more.
    @endsection
@endif
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="d-flex items-center">
                                                    ...
                                                    <div class="form-checkbox ">
                                                        ...
                                                        <input type="checkbox" name="package_type[]"
                                                            {{ request()->get('package_type') == $key ? 'checked' : '' }}
                                                            value="{{ $type }}">
                                        ...
                                        <div class="col-md">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <p class="text-12">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="text-dark-1">{{ $package->reviews != null ? $package->reviews . ' reviews' : '' }}
                                                        </a>
                                                    </p>
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-6 col-8">
                                                            <span
                                                                class="text-13 tag_selector">{{ $package->group_type }}</span>
                                                        </div>
                                                ...
                                                <div class="col-md-auto text-right md:text-left">
                                                    ...
                                                    <a href="{{ route('download.package.pdf', $package->slug) }}"
