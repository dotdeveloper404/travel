...
@section('content')
                                        ...
                                        <div class="accordion__item px-10 py-10 border-bottom-light">
                                            ...
                                            <div class="accordion__button d-flex justify-between items-center">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div
                                                        class="accordion__icon size-40 flex-center bg-close-1 rounded-full mr-20">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="tour-wrapper mb-3">
                        <p> <span class="py-5 px-15 rounded-right-4 text-12 lh-16 fw-500 uppercase bg-blue-1 text-white">
                                {{ str_replace('_', ' ', ucfirst($package->product_type)) }}</span></p>

                        <h2 class="text-30 fw-600 mb-3">{{ $package->package_name }}</h2>
    ...
    @endif-->
                                    ...
                                    Package Price<span class="text-30 fw-700 text-dark-1">
                        ...
                        <div class="swiper-slide shadow-sm rounded-8 bg-white p-3">
                            ...
                            <a href="{{ route('packages.show', $package->slug) }}" class="hotelsCard -type-1 ">
                                ...
                                <div class="hotelsCard__content mt-10">
                                    ...
                                    @foreach ($cities as $city)
                                    {!! in_array($city->id, $package->city) ? "<span class='text-light-1 lh-14 text-14 mt-5'>".ucfirst($city->name)."</span>" : '' !!}
                                @endforeach
