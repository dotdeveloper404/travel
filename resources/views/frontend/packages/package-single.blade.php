                ...
                <div class="relative d-flex justify-center overflow-hidden js-section-slider" data-slider-cols="base-1" data-nav-prev="js-img-prev" data-nav-next="js-img-next">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="{{ $package->images()->count() > 0 ? asset('storage/uploads/package_images/' . $package->images()->get()[0]->name ) :  asset('frontend/img/gallery/1/2.png') }}" alt="image" class="rounded-4 col-12 h-full object-cover">
                        </div>

                        <div class="swiper-slide">
                            <img src="{{ $package->images()->count() > 1 ? asset('storage/uploads/package_images/' . $package->images()->get()[1]->name ) :  asset('frontend/img/gallery/1/2.png') }}" alt="image" class="rounded-4 col-12 h-full object-cover">
                        </div>

                        <div class="swiper-slide">
                            <img src="{{ $package->images()->count() > 2 ? asset('storage/uploads/package_images/' . $package->images()->get()[2]->name ) :  asset('frontend/img/gallery/1/2.png') }}" alt="image" class="rounded-4 col-12 h-full object-cover">
                        </div>

                        <div class="swiper-slide">
                            <img src="{{ $package->images()->count() > 3 ? asset('storage/uploads/package_images/' . $package->images()->get()[3]->name ) :  asset('frontend/img/gallery/1/2.png') }}" alt="image" class="rounded-4 col-12 h-full object-cover">
                        </div>
                    ...
                    <div class="absolute h-full col-12 z-2 px-20 py-20 d-flex justify-end items-end">
                        ...
                        <a href="{{ $package->images()->count() > 0 ? asset('storage/uploads/package_images/' . $package->images()->get()[0]->name ) :  asset('frontend/img/gallery/1/2.png') }}" class="button -blue-1 px-24 py-15 bg-white text-dark-1 js-gallery" data-gallery="gallery2">
                            See All {{ $package->images()->count() }} Photos
                        </a>
                        @endif
                        @foreach($package->images()->get() as $image)
                        <a href="{{ asset('storage/uploads/package_images/' . $image->name ) }}" class="js-gallery" data-gallery="gallery2"></a>
                        @endforeach
                    ...
                    <div class="w-360 lg:w-full d-flex flex-column items-center">
                        <div class="px-30 py-30 rounded-4 border-light bg-white shadow-4">
                            <div class="text-14 text-light-1">
                                Package Price<span class="text-20 fw-500 text-dark-1 ml-5">$ {{ $package->net_amount }}</span>
                            </div>
