                                            ...
                                            <div
                                                ...
                                                <div class="swiper-wrapper">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <img class="col-12 h-full js-lazy" src="#"
                                                            src="{{ url('/image-optimize?image='.asset('storage/uploads/package_images/featured_image/' . $package->featured_image.''))   }}"
                                                            data-src="{{ url('/image-optimize?image='.asset('storage/uploads/package_images/featured_image/' . $package->featured_image.''))   }}"
                        ...
                        <div class="swiper-slide">
                            ...
                            <a href='{{ route('packages.index', ['country' => strtolower($top->country->name), 'city' => $top->name]) }}'
                                ...
                                <div class="citiesCard__image ratio ratio-3:4">
                                    ...
                                    <img 
                                    src="{{ url('/image-optimize?image='.asset($top->image_path))   }}"
                                     data-src="{{ url('/image-optimize?image='.asset($top->image_path))   }}"
                        ...
                        <div class="swiper-slide">
                            ...
                            <a href="packages/locations/{{ strtolower($country->slug) }}" {{-- /{{   preg_replace('/\s+/', '-', strtolower($country->capital))  }} --}}
                                ...
                                <div class="citiesCard__image ratio ratio-3:4">
                                    ...
                                    <img 
                                    src="{{ url('/image-optimize?image='.asset($country->image_path))   }}"
                                        data-src="{{ url('/image-optimize?image='.asset($country->image_path))   }}" alt="image" class="js-lazy">
                        ...
                        <a href="{{ $blog['link'] }}" class="blogCard -type-1 d-block shadow-sm bg-white rounded-8 p-3">
                            ...
                            <div class="blogCard__image">
                                ...
                                <div class="ratio ratio-4:3 rounded-4 rounded-8">
                                    ...
                                    src="{{ url('/image-optimize?image='.$blog['image'])   }}"
                                    data-src="{{ url('/image-optimize?image='.$blog['image'])   }}"
                                        alt="image">
