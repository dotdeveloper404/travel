                                            ...
                                            <div
                                                ...
                                                <div class="swiper-wrapper">
                                                   ...
                                                   data-src="{{ url('/image-optimize?image='.asset('storage/uploads/package_images/featured_image/' . $package->featured_image.''))   }}"
                                                            ...
                                                            {{-- data-src="{{ route('image-optimize?image='.asset('storage/uploads/package_images/featured_image/' . $package->featured_image.''))   }}" --}}
                ...
                <div class="swiper-wrapper">
                    ...
                    @foreach ($top_country as $country)
                        <div class="swiper-slide">
                            ...
                            <a href="packages/{{ strtolower($country->slug) }}" {{-- /{{   preg_replace('/\s+/', '-', strtolower($country->capital))  }} --}}
                                class="citiesCard -type-1 d-block rounded-4 ">
