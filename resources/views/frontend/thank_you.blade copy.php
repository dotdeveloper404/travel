        ...
        <section class="py-40 bg-light-3">
            <div data-anim="slide-up delay-1" class="container">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="mt-15">
                        <p>
                            We've received your message. It's a privilege to have you choose our packages.

                            Our team is currently processing your request and will get back to you as soon as possible.

                            Kindly keep an eye on your inbox for our email. In the meantime, feel free to browse
                            iLinkTurkey's site and our travel blogs.

                            We also encourage you to follow us on social media platforms.
                        ...
                        <div class="__minibox bg-white shadow-sm p-2 rounded-8">
                            <a href="{{ route('packages.top_category', 'families-and-kids-attractions') }}">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="__imgbx">
                                            <img src="{{ asset('frontend/img/top-category/1.png') }}"
            ...
            <div data-anim-wrap class="container">
                ...
                <div class="row y-gap-40 justify-between pt-50">
                    ...
                    <div data-anim-child="slide-up delay-2" class="col-lg-3 col-sm-6">
                        ...
                        <div class="featureIcon -type-1 ">
                            <div class="d-flex justify-center">
                                <img src="#" data-src="frontend/img/featureIcons/1/1.svg" alt="image"
                                    class="js-lazy">
                            </div>
                    ...
                    <div data-anim-child="slide-up delay-3" class="col-lg-3 col-sm-6">
                        ...
                        <div class="featureIcon -type-1 ">
                            <div class="d-flex justify-center">
                                <img src="#" data-src="frontend/img/featureIcons/1/2.svg" alt="image"
                                    class="js-lazy">
                            </div>
                    ...
                    <div data-anim-child="slide-up delay-4" class="col-lg-3 col-sm-6">
                        ...
                        <div class="featureIcon -type-1 ">
                            <div class="d-flex justify-center">
                                <img src="#" data-src="frontend/img/featureIcons/1/3.svg" alt="image"
                                    class="js-lazy">
                            </div>
