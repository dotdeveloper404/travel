...
<section class="hero">
    ...
    <div class="hero__slider owl-carousel">
        ...
        <div class="hero__items set-bg" data-setbg="../frontend/img/home-banner.png" style="background:linear-gradient(rgba(157 148 148 / 10%), rgba(26 20 20 / 64%)) ,url('../frontend/img/home-banner.png') no-repeat;background-size: cover;
  ...
  background-position: center;">
        ...
        <div class="hero__items set-bg" data-setbg="{{ asset('frontend/img/home-banner-2.png')}}" style="background:linear-gradient(rgba(157 148 148 / 10%), rgba(26 20 20 / 64%)) ,url('../frontend/img/home-banner-2.png') no-repeat;background-size: cover;
  ...
  background-position: center;">
        ...
        <div class="hero__items set-bg" data-setbg="../frontend/img/home-banner-3.png" style="background:linear-gradient(rgba(157 148 148 / 10%), rgba(26 20 20 / 64%)) ,url('../frontend/img/home-banner-3.png') no-repeat;background-size: cover;
    ...
    <div class="container">
        ...
        <div class="row mb-40">
            ...
            <div class="col-md-12 text-center">
                ...
                <h2 class="sectionTitle__title text-dark-1">Why book with ILinkTurkey</h2>
                ...
                <div class="ctaCard -type-1 rounded-4 ">
                    ...
                    <div class="ctaCard__content py-70 px-70 lg:py-30 lg:px-30">
                        ...
                        <div class="d-inline-block mt-30">
                            ...
                            <a href="#" class="button px-48 py-15 -blue-1 -min-180 bg-white text-dark-1">Subscribe</a>
            ...
            <div data-anim-child="slide-up delay-1" class="col-lg-3 col-sm-6">
                ...
                <div class="featureIcon -type-1 shadow-sm rounded-8 bg-white p-3">
                    ...
                    <div class="text-center mt-30">
                        ...
                        <p class="text-15 mt-10">Book with confidence knowing you're getting the best price with our Best Price Guarantee. </p>
            ...
            <div data-anim-child="slide-up delay-2" class="col-lg-3 col-sm-6">
                ...
                <div class="featureIcon -type-1 shadow-sm rounded-8 bg-white p-3">
                    ...
                    <div class="text-center mt-30">
                        ...
                        <p class="text-15 mt-10">Book your dream trip hassle-free with our easy and quick booking process.</p>
            ...
            <div data-anim-child="slide-up delay-3" class="col-lg-3 col-sm-6">
                ...
                <div class="featureIcon -type-1 shadow-sm rounded-8 bg-white p-3">
                    ...
                    <div class="text-center mt-30">
                        ...
                        <p class="text-15 mt-10">Travel with peace of mind knowing our friendly customer care team is available 24/7 to assist you.</p>
    ...
    <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-40 justify-between">
            ...
            <div data-anim-child="slide-up delay-1" class="col-xl-5 col-lg-6">
                ...
                <p class="mt-20 text-white">Don't just take our word for it - hear from our satisfied customers about their unforgettable travel experiences with us.</p>
            ...
            <div class="col-md-6">
                ...
                <div class="newsletter">
                    ...
                    <form action="#">
                        ...
                        <select class="form-control input-field" name="package">
