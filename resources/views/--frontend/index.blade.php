...
<div class="why__books layout-pt-md layout-pb-md">
    <div class="container">
        <div class="row mb-40">
            <div class="col-md-12 text-center">
                <h2 class="sectionTitle__title">Why book with Turkey</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3 mb-3">
                <div class="__box text-center">
                    <div class="text-dark text-4 mb-10">
                        <svg width="48" height="35" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <div class="col-md-3 mb-3">
                <div class="__box text-center">
                    <div class="text-dark text-4 mb-10">
                        <svg width="48" height="35" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                            <path
            ...
            <div class="col-md-3 mb-3">
                <div class="__box text-center">
                    <div class="text-dark text-4 mb-10">
                        <svg width="48" height="35" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path
...
<div class="top__attraction layout-pt-md ">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="__minibox my-5">
                    <a href="#">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="__imgbx">
                                    <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/27/86/94.jpg"
                                        class="rounded-8 d-block" alt="">
                                </div>
                            </div>
                            <div class="col">
                                <div class="__content">
                                    <span class="fw-600 d-block">Bayside Marketplace</span>
                ...
                <div class="__minibox my-5">
                    <a href="#">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="__imgbx">
                                    <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/39/a0/b0.jpg"
                                        class="rounded-8 d-block" alt="">
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="__minibox my-5">
                    <a href="#">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="__imgbx">
                                    <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/a6/09/ac.jpg"
                                        class="rounded-8 d-block" alt="">
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="__minibox my-5">
                    <a href="#">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="__imgbx">
                                    <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/27/62/92.jpg"
                                        class="rounded-8 d-block" alt="">
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="__minibox my-5">
                    <a href="#">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="__imgbx">
                                    <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/c9/a1/ac.jpg"
                                        class="rounded-8 d-block" alt="">
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="__minibox my-5">
                    <a href="#">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="__imgbx">
                                    <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/a6/09/f6.jpg"
                                        class="rounded-8 d-block" alt="">
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="__minibox my-5">
                    <a href="#">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="__imgbx">
                                    <img src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0f/1a/f1/77.jpg"
                                        class="rounded-8 d-block" alt="">
                                </div>
                            </div>
                            <div class="col">
...
<div class="top__destination layout-pt-md layout-pb-md">
        ...
        <div class="row justify-content-center">
                ...
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0b/09/69/a6.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/06/6a/e2/a1.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/10/2b/68/07.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0a/b0/dc/bd.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0d/07/a2/c1.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
        ...
        <div class="row mt-15 justify-content-center">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0f/87/e7/75.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0c/01/50/e1.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0b/c2/06/4e.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
            ...
            <div class="col-md-2 mb-3">
                <div class="__destiny-box">
                    <a href="#">
                        <div class="__destiny-content">
                            <img src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0b/a0/64/14.jpg"
                                class="rounded-8" alt="">
                            <div class="title">
...
<!-- interest start  -->
<section class="layout-pb-lg relative">
    <div class="container">
        <div class="row">
        ...
        <div class="flex-center overflow-hidden interest-section-slider" data-slider-cols="base-1"
                                ...
                                <div class="cardImage ratio ratio-1:1">
                                    <div class="cardImage__content">
                                        ...
                                        <img class="rounded-4 col-12 js-lazy" src="#"
                                            data-src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0f/24/64/0a.jpg"
                                            alt="image">
                            ...
                            <div class="tourCard__image">
                                ...
                                <div class="cardImage ratio ratio-1:1">
                                    <div class="cardImage__content">
                                        ...
                                        <img class="rounded-4 col-12 js-lazy" src="#"
                                            data-src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0a/a4/5b/7f.jpg"
                                            alt="image">
                            ...
                            <div class="tourCard__image">
                                ...
                                <div class="cardImage ratio ratio-1:1">
                                    <div class="cardImage__content">
                                        ...
                                        <img class="rounded-4 col-12 js-lazy" src="#"
                                            data-src="https://media.tacdn.com/media/attractions-splice-spp-360x240/06/e5/d8/0e.jpg"
                                            alt="image">
                            ...
                            <div class="tourCard__image">
                                ...
                                <div class="cardImage ratio ratio-1:1">
                                    <div class="cardImage__content">
                                        ...
                                        <img class="rounded-4 col-12 js-lazy" src="#"
                                            data-src="https://media.tacdn.com/media/attractions-splice-spp-360x240/0b/2f/f1/4e.jpg"
                                            alt="image">
                            ...
                            <div class="tourCard__image">
                                ...
                                <div class="cardImage ratio ratio-1:1">
                                    <div class="cardImage__content">
                                        ...
                                        <img class="rounded-4 col-12 js-lazy" src="#"
                                            data-src="https://media.tacdn.com/media/attractions-splice-spp-360x240/06/70/4c/c1.jpg"
                                            alt="image">
...
<section class="layout-pb-lg relative">
    <div class="container">
        ...
        <div class=" flex-center overflow-hidden warmDestiny-slider" data-slider-cols="base-1"
