        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    <h1 class="text-30 fw-600">Tours</h1>
                </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex items-center">
                                            <select name="tour_type" class="form-control">
                                                ...
                                                <option {{ request()->get('tour_type') == $key ? 'selected' : ''  }} value="{{$key}}">{{str_replace('_',' ',$tour)}}</option>
                                                @endforeach
                                            </select>
                        ...
                        <div class="shadow-2 pt-30">
                            <div class="row x-gap-20 y-gap-20 p-2">
                                ...
                                <div class="col-md">
                                    ...
                                    <h3 class="text-20 lh-16 fw-800">{{ $tour->tour_name}}</h3>
                                    ...
                                    <p class="text-14 lh-14 mt-5"><i>{{$tour->seasonality}}</i>
                                    </p>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6">
                                            <p class="text-12">{{ date('d/m/Y',strtotime($tour->traveling_date_start)) }}</p>
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6">
                                            <p class="text-12">{{ date('d/m/Y',strtotime($tour->traveling_date_end)) }}</p>
                                        </div>
                                ...
                                <div class="col-md-auto text-right md:text-left">
                                    ...
                                    <div class="row mt-2 text-left">
                                        <div class="col-auto">
                                            <p class="text-12">Tour length <br>
                                                ...
                                                <strong>{{ $tour->nights}} nights</strong>
                                            </p>
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="text-12">From <span class="line-through text-15 fw-600">${{$tour->tour_price}}
                                                ...
                                                US<strong class="text-info-2 text-20"> ${{$tour->net_amount}}</strong>
                                            </p>
                                            @else
                                            <p class="text-12">
                                                US<strong class="text-info-2 text-20"> ${{$tour->net_amount}}</strong>
                                    ...
                                    <a href="{{ route('tours.show',$tour->slug) }}" class="button -md -dark-1 bg-blue-1 text-white mt-20">
