                                ...
                                <div class="d-flex items-center">
                                    <div class="d-flex items-center x-gap-5">
                                       ...
                                       {!! $package->stars == 1 ? ' <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                                            {!! $package->stars == 2 ? ' <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                                            {!! $package->stars == 3 ? ' <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                                            {!! $package->stars == 4 ? ' <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
                                            {!! $package->stars == 5 ? ' <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div> <div class="icon-star text-yellow-1 text-10"></div>' : '' !!}
