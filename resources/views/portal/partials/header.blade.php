					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="../../demo1/dist/index.html" class="d-lg-none">
								<img alt="Logo" src="portal/theme/assets/media/logos/default-small.svg" class="h-30px" />
							</a>
						</div>
						<!--end::Mobile logo-->
												...
												<div class="tab-content py-4 py-lg-8 px-lg-7">
													...
													<div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
														...
														<div class="row">
															...
															<!--begin:Col-->
															<div class="col-lg-4">
																<img src="portal/theme/assets/media/stock/600x600/img-82.jpg" class="rounded mw-100" alt="" />
															</div>
															<!--end:Col-->
														</div>
														<!--end:Row-->
													...
													<div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
														...
														<div class="row">
															...
															<!--begin:Col-->
															<div class="col-lg-7">
																<img src="portal/theme/assets/media/stock/900x600/46.jpg" class="rounded mw-100" alt="" />
															</div>
															<!--end:Col-->
														</div>
														<!--end:Row-->
													...
													<div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
														...
														<div class="row">
															...
															<div class="col-lg-5 pe-lg-5">
																<img src="portal/theme/assets/media/stock/600x600/img-84.jpg" class="rounded mw-100" alt="" />
															</div>
															<!--end:Col-->
														</div>
														<!--end:Row-->
													...
													<div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
														...
														<div class="row">
															...
															<!--begin:Col-->
															<div class="col-lg-8">
																<img src="portal/theme/assets/media/stock/900x600/44.jpg" class="rounded mw-100" alt="" />
															</div>
															<!--end:Col-->
														</div>
														<!--end:Row-->
											...
											<div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
												...
												<div class="row">
													...
													<div class="col-lg-6 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
														<img src="portal/theme/assets/media/stock/900x600/45.jpg" class="rounded mw-100" alt="" />
													</div>
													<!--end:Col-->
												</div>
												<!--end:Row-->
							...
							<div class="app-navbar flex-shrink-0">
													...
													<div class="scroll-y mh-200px mh-lg-350px">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<img src="portal/theme/assets/media/avatars/300-6.jpg" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="portal/theme/assets/media/avatars/300-2.jpg" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-semibold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="portal/theme/assets/media/avatars/300-9.jpg" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-semibold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="portal/theme/assets/media/avatars/300-14.jpg" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-semibold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="portal/theme/assets/media/avatars/300-11.jpg" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-semibold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="portal/theme/assets/media/svg/brand-logos/volicity-9.svg" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="portal/theme/assets/media/svg/brand-logos/tvit.svg" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="portal/theme/assets/media/svg/misc/infography.svg" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="portal/theme/assets/media/svg/brand-logos/leaf.svg" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="portal/theme/assets/media/svg/brand-logos/tower.svg" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
								...
								<div class="app-navbar-item ms-1 ms-lg-3">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
										<!--begin::Heading-->
										<div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('portal/theme/assets/media/misc/menu-header-bg.jpg')">
											<!--begin::Title-->
											...
											<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
												...
												<div class="d-flex flex-column px-9">
													...
													<div class="text-center px-4">
														<img class="mw-100 mh-200px" alt="image" src="portal/theme/assets/media/illustrations/sketchy-1/1.png" />
													</div>
													<!--end::Illustration-->
												</div>
												<!--end::Wrapper-->
													...
													<div class="row g-2">
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/amazon.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/angular-icon-1.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/atica.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/beats-electronics.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/codeigniter.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/bootstrap-4.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/google-tag-manager.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/disqus.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/dribbble-icon-1.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/google-play-store.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/google-podcasts.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/figma-1.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/github.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/gitlab.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/instagram-2-1.svg" class="w-25px h-25px mb-2" alt="" />
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<img src="portal/theme/assets/media/svg/brand-logos/pinterest-p.svg" class="w-25px h-25px mb-2" alt="" />
								...
								<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										<img src="portal/theme/assets/media/avatars/300-1.jpg" alt="user" />
									</div>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="portal/theme/assets/media/avatars/300-1.jpg" />
												</div>
												<!--end::Avatar-->
												<!--begin::Username-->
												<div class="d-flex flex-column">
										...
										<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
											<a href="#" class="menu-link px-5">
												...
												<img class="w-15px h-15px rounded-1 ms-2" src="portal/theme/assets/media/flags/united-states.svg" alt="" /></span></span>
											</a>
											<!--begin::Menu sub-->
											<div class="menu-sub menu-sub-dropdown w-175px py-4">
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													...
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="portal/theme/assets/media/flags/united-states.svg" alt="" />
													</span>English</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													...
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="portal/theme/assets/media/flags/spain.svg" alt="" />
													</span>Spanish</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="portal/theme/assets/media/flags/germany.svg" alt="" />
													</span>German</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="portal/theme/assets/media/flags/japan.svg" alt="" />
													</span>Japanese</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="../../demo1/dist/account/settings.html" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="portal/theme/assets/media/flags/france.svg" alt="" />
													</span>French</a>
												</div>
												<!--end::Menu item-->
											</div>
