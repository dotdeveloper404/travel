			...
			<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
				...
				<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.city.index')}}">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.city.create') }}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
					...
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.country.index')}}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
									<span class="menu-title">List</span>
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.country.create') }}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
									<span class="menu-title">Add New</span>
					...
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
						...
						<span class="menu-link">
							...
							<span class="menu-title">Places to visit</span>
							<span class="menu-arrow"></span>
						</span>
						<!--end:Menu link-->
						<!--begin:Menu sub-->
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.destination.index')}}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
									<span class="menu-title">List</span>
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.destination.create') }}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
									<span class="menu-title">Add New</span>
					...
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.tour.index')}}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
									<span class="menu-title">List</span>
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.tour.create') }}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
									<span class="menu-title">Add New</span>
					...
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="{{ route('portal.contact.index')}}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
									<span class="menu-title">List</span>
